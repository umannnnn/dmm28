...
<head>
    ...
    <!-- <script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="88c6e446-0bca-4aa2-8640-de8fc8e3c121";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script> -->
</head>
<body>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-2 ">
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body">
                            ...
                            <a href="booking.php?id_mobil=<?= $row["id_mobil"]; ?>" class="btn btn-primary">Booking Now!</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
